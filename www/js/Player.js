	...
	function Player() {
        ...
        this.checkTileAction = function(){
            for (var i=0; i < this.hitBox.length-2; i++){ //no need to check gap checking points
                ...
                else if (this.hitBox[i].type == 4 && (i == 3 || i == 2) && this.gravity.isFalling()){ this.playerState = 0; createjs.Sound.play("impact"); }
                ...
                else if (this.hitBox[i].type == 7 && (i == 1 || i == 2)){ this.playerState = 0; createjs.Sound.play("impact"); }
